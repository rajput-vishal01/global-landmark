  ...
  try {
    ...
    if (!sent) {
      return {
        status: "error",
        message:
          "Our mail service is temporarily unavailable. Please email us directly at inquiries@globallandmark.com.",
      };
    }
    return { status: "sent" };
  } catch (err) {
    ...
    return {
      status: "error",
      message:
        "Something went wrong sending your message. Please try again, or email us directly at inquiries@globallandmark.com.",
    };
  }
}
