...
// Links use external (subdomain) paths — proxy rewrites them to /admin/*.
const NAV = [
...
export default async function AdminPanelLayout({
  ...
  // Defense in depth: the proxy gates the subdomain, but panel pages must
  // never depend on the matcher alone (Next data-security guidance).
